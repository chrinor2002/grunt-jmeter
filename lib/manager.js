...
var pluginNames = {
	'extraslibs': 'http://jmeter-plugins.org/downloads/file/JMeterPlugins-ExtrasLibs-1.2.0.zip'
};
...
module.exports.extractPlugin = function(filePath, callback) {
	...
	//module.exports.extract(filePath, function(err){
	//	callback(err, filePath);
	//})

	console.log('aaaaaaa', filePath);
	console.log('aaaaaaa', extractedFolder);
